...
for date in dates:
    with open('pickle_files/2_to_5Hz/'+ date + '_0600_2to5Hz.pkl','rb') as f:
...
plt.suptitle('2 to 5 Hz, N=22',fontsize=22,weight='bold')
plt.savefig('Figures/Fig_S3.jpg',dpi=800)
